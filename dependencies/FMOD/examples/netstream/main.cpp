...
int main(int argc, char *argv[])
{
    ...
    */
    ...
    /*        Bump up the file buffer size a little bit for net streaming. Decode buffer is left at default
    */
    result = system->setStreamBufferSize(64*1024, FMOD_TIMEUNIT_RAWBYTES);
    ERRCHECK(result);

    result = system->createSound(argv[1], FMOD_SOFTWARE | FMOD_2D | FMOD_CREATESTREAM | FMOD_NONBLOCKING,  0, &sound);
    ERRCHECK(result);
