...
FMOD_RESULT F_CALLBACK eventcallback(FMOD_EVENT *event, FMOD_EVENT_CALLBACKTYPE type, void *param1, void *param2, void *userdata)
{
    ...
    {
        unsigned int property = *((unsigned int *)&param1);
        float value = *((float *)&param2);

        printf("%p %s %f (%p)\n", event, property == FMOD_EVENTPROPERTY_VOLUME ? "volume" : FMOD_EVENTPROPERTY_PITCH ? "pitch" : "???", value, userdata);
    }
...
int main(int argc, char *argv[])
{
    ...
    printf("======================================================================\n");
    printf("Realtime Tweaking. Copyright (c) Firelight Technologies 2004-2016.\n");
    printf("======================================================================\n");
